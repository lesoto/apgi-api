...
class TestValidateCeleryUrls:
    ...
    def test_validate_celery_urls_valid_redis(self, clear_celery_mock):
    ...
    def test_validate_celery_urls_valid_redis_socket(self, clear_celery_mock):
    ...
    def test_validate_celery_urls_missing_broker(self, clear_celery_mock):
    ...
    def test_validate_celery_urls_missing_backend(self, clear_celery_mock):
    ...
    def test_validate_celery_urls_none_broker(self, clear_celery_mock):
    ...
    def test_validate_celery_urls_none_backend(self, clear_celery_mock):
    ...
    def test_validate_celery_urls_invalid_scheme_broker(self, clear_celery_mock):
    ...
    def test_validate_celery_urls_invalid_scheme_backend(self, clear_celery_mock):
    ...
    def test_validate_celery_urls_invalid_broker_url_no_hostname(self, clear_celery_mock):
    ...
    def test_validate_celery_urls_invalid_backend_url_no_hostname(self, clear_celery_mock):
...
class TestModuleLevel:
    ...
    def test_validate_function_exists(self, clear_celery_mock):
