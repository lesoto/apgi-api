...
class TestModuleStructure:
    ...
    def test_task_classes_defined(self) -> None:
    ...
    def test_celery_tasks_defined(self) -> None:
    ...
    def test_trigger_webhook_function_defined(self) -> None:
...
class TestAPGIImportHandling:
    ...
    def test_apgi_classes_none_when_unavailable(self) -> None:
...
class TestCeleryTaskSignatures:
    ...
    def test_iowa_gambling_task_signature(self) -> None:
    ...
    def test_masking_paradigm_task_signature(self) -> None:
    ...
    def test_attentional_blink_task_signature(self) -> None:
    ...
    def test_change_blindness_task_signature(self) -> None:
    ...
    def test_binocular_rivalry_task_signature(self) -> None:
