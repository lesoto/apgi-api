...
@pytest.fixture
def mock_business_metrics_service() -> MagicMock:
...
@pytest.fixture
def mock_profiling_service() -> MagicMock:
...
class TestMetricsRoutes:
    ...
    @pytest.mark.asyncio
    async def test_get_dashboard_overview(self, mock_business_metrics_service: MagicMock) -> None:
        ...
        async def mock_async_overview() -> dict[str, Any]:
    ...
    @pytest.mark.asyncio
    async def test_get_dashboard_overview_exception(
        self, mock_business_metrics_service: MagicMock
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_dashboard_sessions_valid_days(
        self, mock_business_metrics_service: MagicMock
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_dashboard_sessions_invalid_days_too_low(
        self, mock_business_metrics_service: MagicMock
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_dashboard_sessions_exception(
        self, mock_business_metrics_service: MagicMock
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_dashboard_tasks(self, mock_business_metrics_service: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_dashboard_tasks_invalid_days(
        self, mock_business_metrics_service: MagicMock
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_dashboard_users(self, mock_business_metrics_service: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_dashboard_users_invalid_days(
        self, mock_business_metrics_service: MagicMock
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_dashboard_templates(self, mock_business_metrics_service: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_dashboard_templates_invalid_days(
        self, mock_business_metrics_service: MagicMock
    ) -> None:
    ...
    async def test_get_complete_dashboard_with_cache(
        self, mock_business_metrics_service: MagicMock, mock_cache_service: AsyncMock
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_complete_dashboard_invalid_days(
        self, mock_business_metrics_service: MagicMock
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_complete_dashboard_exception(
        self, mock_business_metrics_service: MagicMock
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_dashboard_html(self, mock_business_metrics_service: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_dashboard_html_invalid_days(
        self, mock_business_metrics_service: MagicMock
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_dashboard_html_exception(
        self, mock_business_metrics_service: MagicMock
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_start_memory_tracing(self, mock_profiling_service: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_start_memory_tracing_exception(self, mock_profiling_service: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_stop_memory_tracing(self, mock_profiling_service: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_stop_memory_tracing_exception(self, mock_profiling_service: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_memory_snapshot(self, mock_profiling_service: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_memory_snapshot_exception(self, mock_profiling_service: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_system_performance(self, mock_profiling_service: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_system_performance_exception(
    ...
    @pytest.mark.asyncio
    async def test_get_performance_history_valid_hours(
        self, mock_profiling_service: MagicMock
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_performance_history_invalid_hours_too_low(
        self, mock_profiling_service: MagicMock
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_performance_history_invalid_hours_too_high(
        self, mock_profiling_service: MagicMock
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_performance_history_exception(
        self, mock_profiling_service: MagicMock
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_bottleneck_analysis(self, mock_profiling_service: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_bottleneck_analysis_exception(
        self, mock_profiling_service: MagicMock
    ) -> None:
