...
class TestRetryService:
    ...
    @pytest.mark.asyncio
    async def test_execute_with_retry_success_first_try(self, retry_service):
    ...
    @pytest.mark.asyncio
    async def test_execute_with_retry_success_after_retry(self, retry_service):
    ...
    @pytest.mark.asyncio
    async def test_execute_with_retry_exhaust_retries(self, retry_service):
    ...
    def test_calculate_delay_no_jitter(self, retry_service):
    ...
    def test_calculate_delay_max_delay(self, retry_service):
...
class TestErrorRecoveryService:
    ...
    def test_register_service(self, error_recovery_service):
    ...
    def test_register_service_with_custom_config(self, error_recovery_service):
    ...
    @pytest.mark.asyncio
    async def test_call_external_service_unregistered(self, error_recovery_service):
    ...
    @pytest.mark.asyncio
    async def test_call_external_service_registered_success(self, error_recovery_service):
    ...
    @pytest.mark.asyncio
    async def test_call_external_service_registered_failure(self, error_recovery_service):
    ...
    def test_get_service_stats(self, error_recovery_service):
    ...
    def test_get_service_stats_unknown_service(self, error_recovery_service):
        """Test getting stats for unknown service."""
        stats = error_recovery_service.get_service_stats("unknown_service")

        assert stats is None

    def test_get_all_stats(self, error_recovery_service):
    ...
    def test_reset_circuit_breaker(self, error_recovery_service):
...
def test_get_error_recovery_service():
