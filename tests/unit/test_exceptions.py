...
class TestAPIErrorBase:
    ...
    def test_api_error_initialization_without_details(self):
    ...
    def test_api_error_to_dict_without_request_id(self):
    ...
    def test_api_error_to_dict_timestamp_format(self):
...
class TestSessionExceptions:
    ...
    def test_session_state_conflict_error_inheritance(self):
...
class TestTaskExceptions:
    ...
    def test_invalid_task_type_error_inheritance(self):
...
class TestValidationExceptions:
    ...
    def test_invalid_configuration_error_without_errors(self):
...
class TestAuthenticationExceptions:
    ...
    def test_invalid_token_error_default_reason(self):
    ...
    def test_authorization_error_without_role(self):
...
class TestResourceExceptions:
    ...
    def test_service_unavailable_error_without_reason(self):
    ...
    def test_database_error_with_reason(self):
    ...
    def test_database_error_without_reason(self):
...
class TestExportExceptions:
    ...
    def test_export_format_error_inheritance(self):
        """Test ExportFormatError inherits from APIError."""
        error = ExportFormatError("format", [])
        assert isinstance(error, APIError)

    def test_no_data_available_error(self):
    ...
    def test_no_data_available_error_inheritance(self):
...
class TestInternalServerError:
    ...
    def test_internal_server_error_with_error_id(self):
    ...
    def test_internal_server_error_without_error_id(self):
...
class TestExceptionRaisingAndCatching:
    ...
    def test_raise_and_catch_session_not_found(self):
...
class TestExceptionToDict:
    ...
    def test_internal_server_error_to_dict(self):
